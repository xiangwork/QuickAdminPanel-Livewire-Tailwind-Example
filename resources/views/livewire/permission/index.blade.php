<div>
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            分页:
            <select wire:model="perPage" class="form-select w-full sm:w-1/6 rounded">
        ...
        <div class="w-full sm:w-1/2 sm:text-right">
            <label>
                搜索:
                <input type="text" wire:model.debounce.300ms="search" class="w-full sm:w-1/3 inline-block rounded"/>
            </label>
        </div>
    </div>
